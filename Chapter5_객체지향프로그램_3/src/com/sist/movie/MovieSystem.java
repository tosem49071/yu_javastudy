 ...
 *    
 *    [{"startYearDate":"2023.04.12","endYearDate":"2023.04.12","startDate":"2023년 04월 12일(수)","endDate":"2023년 04월 12일(수)",
 *    "movieCd":"20231089","showDt":"20230412","thumbUrl":"/common/mast/movie/2023/04/thumb/thn_30be7bc08e504eaab8cd9545aa64749d.jpg",
 *    "movieNm":"존 윅 4","movieNmEn":"John Wick: Chapter 4","synop":"죽을 위기에서 살아난 ‘존 윅’은 ‘최고 회의’를 쓰러트릴 방법을 찾아낸다.\r\n비로소 완전한 자유의 희망을 보지만 NEW 빌런 ‘그라몽 후작’과 전 세계의 최강 연합은 \r\n‘존 윅’의 오랜 친구까지 적으로 만들어 버리고, 새로운 위기에 놓인 ‘존 윅’은 최후의 반격을 준비하는데...\r\n\r\n레전드 액션 블록버스터 &lt;존 윅&gt;의 새로운 챕터가 열린다!","prdtYear":"2023","indieYn":null,
 *    "artmovieYn":null,"multmovieYn":null,"showTm":"169","showTs":"5","director":"채드 스타헬스키","prNm":null,
 *    "dtNm":"(주)레드아이스 엔터테인먼트","repNationCd":"미국","movieType":"장편","moviePrdtStat":"개봉","genre":"액션",
 *    "watchGradeNm":"청소년관람불가","openDt":"20230412",
 *    "salesAmt":1144439006,
 *    "audiCnt":113149,
 *    "scrCnt":1525,
 *    "showCnt":4665,
...
public class MovieSystem {
	...
	Movie[] movieListData(int no)
	{
		...
		try
		{
			// [{},{},{},{}...] JSON이 무엇이냐? 자바에서 객체를 표현할때 쓰는
			// [] => JSONArray
			// {} => JSONObject
			Document doc=Jsoup.connect(url).get();
			//System.out.println(doc.toString());
			String msg=doc.toString();
			msg=msg.substring(msg.indexOf("["),msg.lastIndexOf("]")+1);//마지막 제외 꼭 +1
