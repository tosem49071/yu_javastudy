 ...
 *    컬렉션 프레임워크
 *    ------------
 *    1. 다수의 데이터를 쉽고 효율적으로 처리할 수 있게 만든 표준화된 클래의 집합
 *                  -------------- 자바에서 라이브러리로 지원
 *    2. 데이터 => 수정, 삭제, 추가, 읽기 (자료구조)
 *    3. 배열 => 정적 메모리 할당 (추가가 어렵다)
 *       => 동적 메모리 할당 (추가를 쉽게 할수있다)
 ...
 *       = 먼저 들어온 데이터를 먼저 출력
 *         Queue(FIFO), Stack(LIFO) => 코딩테스트 대표적인..
 *         -----------  -----------
 *          순차적으로      뒤에서부터   => 1차원 배열
...
public class 라이브러리_Collection {
	...
	public static void main(String[] args) {
		...
		set.add("A"); // add(Object o)문자숫자 다들어갈수있다
		set.add("B");
		set.add("C");
		set.add("D");
		///////////////  중복된 데이터 => 허용하지 않는다
		...
		set.add("C");
		// 출력
		for(Object obj:set) // 선언할때 형변환XXX
		{
			// for-each구문은 형변환이 안된다 
			String s=(String)obj; // 형변환시키고싶으면 여기에서
			System.out.print(s+" ");
		}
	}
