 ...
 *                   생성자 : 다른 클래스에서 메모리 할당후 사용 => 모든 클래스에서 접근 가능
 *                   메소드 : 다른 클래스와 통신을 담당
 *          ===> private / public
 *          ------------------ 접근지정어 -------------------
 ...
 *            메소드 제작방법 (형식)
 *            [접근지정어(public)][제시어] 리턴형 메소드명(매개변수 목록) => 선언부
 *            {
 *               구현부
 *            }
 *            
 ...
 *        class B extends A
 *        {
 *           void display(){} // class A에 있는거 가져온거
 *        }
 ...
 *           // 멜론/지니뮤직/Mnet
 *           ------------------
 *      = 유지보수용 (SM) => Jquery(Ajex) => Vue,React
 *      = 단일 상속만 가능하다
 *        class A
 *        class B extends A
 *        class C extends B
...
// Super로부터 상속을 받는다 => 예외조건) 생성자, 초기화 블록,  
class Data
{
	private int a;
...
/*class Human
{
	public void getData()
	{
		Data d=new Data();  //여기는 100 저장
		d.setA(100);
	}
	public void print()
	{
		Data d=new Data();  //여기는 아니다 // 따로따로 할당했다
		System.out.println("d.a="+d.getA());
	}
}*/
class Human
{
	Data d=new Data();      //이경우 같다
