 ...
 *       6) 객체 지향 프로그램 
 *       7) 프로그램이 비정상 종료를 방지 / 오류를 처리 = 예외처리 ex) 계산기 8을 0으로 나눴을때 종료가 아닌 '0으로 나눌수없습니다'로 처리
 *       ========================================================================================== 자바기본
 *       8) 자바에서 지원하는 라이브러리 
 *    3. 자바의 구성
 *       package : 한번만 사용 => 위치
 *       import : 기존에 만들어진 클래스르 불러온다 (여러개)
 *       ------------------------------------------
 *       class ClassName{
 *          -------------------
 *             변수 설정
 ...
 *    값을 부여 크기에 맞게 지정한다
 *    
 *    int a=10.5 ==> 오류 (int가 아닌 double 써야함)
 *    ---   ----
 *    4byte  8byte
 *    
 *    데이터형 크기
...
public class 변수 {
	...
	public static void main(String[] args) {
		...
		//int a=10000000000;   ==> 21억을 넘어갔기 때문에 에러
