 ...
 *  BufferInputStream  BufferedOutStream
 *  ----------------------------------------
 *  ObjectIInputStream / ObjectOutputStream
 *  
 *  *** 모드(mode) => r , w , a
 *                  read , write , append
 *                  -----  -----
 *                  Reader Writer
 *                  
 *                  => new FileWriter("파일명",true) => append      //한파일에 계속 씀
 *                  => new FileWriter("파일명") => create           //한번쓰고 끝
 *   ---------------------------------------------------------------------------
 *    File : 독립 클래스
 *    ==> 1) 파일
 *        2) 디렉토리 (폴더)
...
public class InputOutputMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("수정 날짜:"+new SimpleDateFormat("yyyy년 MM월 dd일 hh시 mm분 ss초").
				            format(new Date(file.lastModified()))); // new Date주면 날짜로 바뀐다
