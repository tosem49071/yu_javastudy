 ...
 *             상수 
 *               int a; ==> 오류나는 코드
 *               (public static final)int a=10;  ==> 상수형은 값을 줘야 오류안난다
 *               --------------------- 자동 추가
 *            ----------------------
 *             추상메소드
 *               void display();
 ...
 *         interface A
 *         class B ( implements ) A
 *         * class     ===> interface     // 이런과정은 없음
 *         -------------------------------
 *         class A
 *         interface B (     ) A  => 오류  // 이런과정은 없음
 *         -------------------------------
 *         
 *         interface A 
 *         interface B extends A
 ...
 *         interface A
 *         interface B
 *         class C implements A,B ===> 다중상속  // implements 동시에 두개 받을수 있다 
 *         
 *         interface A
 *         interface B
 *         class C
 *         class D extends C implements A,B   // 3개를 동시에 받기 가능
 *         
 *         class E extends JFrame implements MouseListener, KeyListener,
 *                                           ActionListener, Runnable
 *         => Game : 마우스이용, 키보드 이용, 버튼 이용, 쓰레드 이용
 *     247 page => 형식
 *         일반메소드
 *         interface A
 *         {
