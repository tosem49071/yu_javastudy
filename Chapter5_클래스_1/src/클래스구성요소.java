 ...
 *                      ***오라클 연결
 *                      데이터 삭제
 *                      ***오라클 닫기           //***한 반복되는 부분을 메소드로 처리하는 것(중복 제거)   ex)nextInt()
 *                     --------------
 ...
 *               --- 여기가 더 클수도 있다 (double, float, long)가 올수도 있지만 => int권장
 *               {
 *                  //구현부
 *                  int c=a+b;
 *                  
